...
export default function HomePage() {
  ...
  return (
    <div
      ...
      style={{ background: "var(--paper)", padding: 10, gap: 10 }}
    >
      <LeftNav />
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto page-in" style={{ padding: "44px 52px 60px" }}>
          ...
          <section style={{ marginBottom: 52 }}>
            ...
            <p style={{ fontSize: 15, color: "var(--ink-2)", marginBottom: 28 }}>
...
function SessionCard({
  ...
  return (
    ...
    >
      ...
      <p style={{ fontSize: 12, color: "var(--ink-2)", marginBottom: 2 }}>
...
function EmptyState({ onStart }: { onStart: () => void }) {
  return (
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", padding: "48px 0", gap: 14 }}>
      <p style={{ fontSize: 14, color: "var(--ink-3)", margin: 0 }}>No sessions yet</p>
      <button
        onClick={onStart}
        className="btn-ink"
        style={{ height: 38, paddingLeft: 20, paddingRight: 20, fontSize: 13 }}
      >
